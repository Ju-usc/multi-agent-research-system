    ...
    async def execute_subagent_task(self, task: SubagentTask, subagent_lm) -> Optional[SubagentResult]:
        ...
        try:
            ...
            with dspy.context(lm=subagent_lm):
                sub = dspy.ReAct(ExecuteSubagentTask, tools=[self.tools["web_search"]], max_iters=task.tool_budget)
...
if __name__ == "__main__":
    ...
    query = "Doue vs Yamal who's better? Be objective and keep it research short and concise"
